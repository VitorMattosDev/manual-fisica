...
- [ ] `volumes/v1-fundamentos/01-grandezas-unidades.qmd` — Grandezas, SI e conversões
...
- [ ] `volumes/v4-fluidos/01-estatica-fluidos.qmd` — Estática (pressão, empuxo)
...
- [ ] `volumes/v7-eletromagnetismo1/06-corrente-resistencia.qmd` — Corrente, resistência, Ohm
...
- [ ] `volumes/v9-optica/01-natureza-luz.qmd` — Natureza e propagação da luz
